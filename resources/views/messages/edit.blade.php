                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $message->name }}" required autocomplete="name" autofocus>
                                        @error('name')
                                    ...
                                    <div class="form-group col-12 mt-3">
                                        ...
                                        <textarea class="form-control" id="sms-ckeditor" name="sms">{{ $message->sms }}</textarea>
                                    </div>
                                    <div class="form-group col-12 mt-3">
                                        <label>Email Content</label>
                                        <textarea class="form-control" id="email-ckeditor" name="email">{{ $message->email }}</textarea>
