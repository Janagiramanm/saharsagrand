                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                     ...
                     <div class="user-form-section">
                        ...
                        <div class="form-group row">
                            <label for="flat_number" class="col-md-4 col-form-label text-md-right">{{ __('Flat Number') }}</label>

                            <div class="col-md-6">
                                <input id="block" type="flat_number" class="form-control @error('flat_number') is-invalid @enderror" name="flat_number" value="{{ old('flat_number') }}" required autocomplete="flat_number">
                    ...
                    <div class="otp-section">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="otp" type="otp" class="form-control @error('otp') is-invalid @enderror" name="otp"  autocomplete="otp">
